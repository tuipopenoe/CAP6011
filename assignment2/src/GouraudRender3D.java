...
class PlaneEqn3{
    ...
    // Constructor
    public PlaneEqn3(int x1val, int y1val, int z1val, float r1val, 
        float g1val, float b1val, int x2val, int y2val, int z2val,
...
public class GouraudRender3D extends Render3D{
    ...
    public void Draw(Raster rast, int v[], float r[],float g[],float b[],
        int color){
        ...
        if((x1 < 0 && x2 < 0 && x3 < 0) || ( x1 > rast.width && x2 > 
            rast.width && x3 > rast.width)){
            return;
        }
        ...
        PlaneEqn3 p1, p2;
        if(area2 > 0){
            p1 = new PlaneEqn3( x1, y1, z1, r[VertixOrder[0]],
                                g[VertixOrder[0]],b[VertixOrder[0]],
                                x3, y3, z3, r[VertixOrder[2]],
                                g[VertixOrder[2]], b[VertixOrder[2]]);
            p2 = new PlaneEqn3( x1, y1, z1, r[VertixOrder[0]],
                                g[VertixOrder[0]], b[VertixOrder[0]],
                                x2, y2, z2, r[VertixOrder[1]],
                                g[VertixOrder[1]],b[VertixOrder[1]]);
        }
        else{
            p2 = new PlaneEqn3( x1, y1, z1, r[VertixOrder[0]],
                                g[VertixOrder[0]], b[VertixOrder[0]],
        ...
        for(int cy=y1;cy<y2;cy++){
            ...
            float tg=p1.getG();
            float tb=p1.getB();
            int tx1=(int) p1.getX(), tx2=(int) p2.getX();
        ...
        if(area2>0){
            p2 = new PlaneEqn3( x2, y2, z2, r[VertixOrder[1]], 
                                g[VertixOrder[1]], b[VertixOrder[1]],
                                x3, y3, z3, r[VertixOrder[2]],
                                g[VertixOrder[2]], b[VertixOrder[2]]);
        }
        else{
            p1 = new PlaneEqn3( x2, y2, z2, r[VertixOrder[1]],
                                g[VertixOrder[1]], b[VertixOrder[1]],
                                x3, y3, z3, r[VertixOrder[2]],
                                g[VertixOrder[2]], b[VertixOrder[2]]);
         }
