...
class PlaneEqn2
{
    ...
    public PlaneEqn2(int x1val, int y1val, int z1val,int x2val, int y2val, 
        int z2val){
...
public class FlatRender3D extends Render3D{
    protected void SortVertex(int v[]){
        // Sort vertex by Y coordinate  
        int min,max;
    ...
    public void Draw(Raster r,int v[],float dummyr[],float dummyg[], 
        float dummyb[], int color){
        SortVertex(v);
