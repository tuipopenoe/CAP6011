...
function passVal(){
    document.DrawGraphic.angleVal(document.angle.value);
    document.DrawGraphic.rotateX1Val(document.getElementById(rotateX1.value));
    document.DrawGraphic.rotateX2Val(document.getElementById(rotateX2.value));
    document.DrawGraphic.rotateY1Val(document.getElementById(rotateY1.value));
    document.DrawGraphic.rotateY2Val(document.getElementById(rotateY2.value));
    document.DrawGraphic.rotateZ1Val(document.getElementById(rotateZ1.value));
    document.DrawGraphic.rotateZ2Val(document.getElementById(rotateZ2.value));
    document.DrawGraphic.translateXVal(document.getElementById(translateX.value));
    document.DrawGraphic.translateYVal(document.getElementById(translateY.value));
    document.DrawGraphic.translateZVal(document.getElementById(translateZ.value));
    document.DrawGraphic.scaleXVal(document.getElementById(scaleX.value));
    document.DrawGraphic.scaleYVal(document.getElementById(scaleY.value));
    document.DrawGraphic.scaleZVal(document.getElementById(scaleZ.value));
...
function ambientLightPassVal(){
    document.DrawGraphic.AmbientLightVal(document.getElementById(ambientLight).checked);
    document.DrawGraphic.UPDATE();
}

function GouraudShapePassVal(){
    if(document.shapeRadio2.checked==true){
        document.DrawGraphic.GouraudShapeVal(document.getElementById(shapeRadio2).checked);
        document.DrawGraphic.UPDATE();
    }
}
...
function FlatShapePassVal(){
    if(document.shapeRadio2.checked==true){
        document.DrawGraphic.FlatShapeVal(document.getElementById(shapeRadio1).checked);
        document.DrawGraphic.UPDATE();
    }
}